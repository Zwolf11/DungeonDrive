...
namespace DungeonDrive
{
    public class GameState : State
    {
        ...
        private Boolean door_triggered = false;
        private Boolean chest_triggered = false;
        ...
        private void loadGame()
        {
            ...
            if (weapon[0] != "NULL")
                hero.weapon = new Weapon(this, weapon[0], int.Parse(weapon[1]), int.Parse(weapon[2]), bool.Parse(weapon[3]), double.Parse(weapon[4]), double.Parse(weapon[5]), int.Parse(weapon[6]), double.Parse(weapon[7]), double.Parse(weapon[8]), int.Parse(weapon[9]) );
                ...
                for (int i = 0; i < inventory.Length; i++)
                {
                    ...
                    if(item[0] != "NULL")
                    {
                        if (item[0] == "HELMET")
                            ...
                            inventory[i][j] = new Weapon(this, item[1], int.Parse(item[2]), int.Parse(item[3]), bool.Parse(item[4]), double.Parse(item[5]), double.Parse(item[6]), int.Parse(item[7]), double.Parse(item[8]), double.Parse(item[9]), int.Parse(item[10]));
